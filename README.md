...
## 1. Instalasi Package
Menambahkan dependencies carousel_slider pada file pubspec.yaml agar bisa menggunakan fitur carousel pada aplikasi.
...
Mengimpor package carousel_slider di bagian atas file main.dart, agar fungsi carousel dapat digunakan di seluruh halaman.
...
Bagian body berisi seluruh tampilan utama aplikasi, mulai dari:
...
Semua ditata dalam SingleChildScrollView agar tampilan bisa digulir ke bawah.
...
Menambahkan navigasi bawah dengan tiga menu utama:
- Home → halaman utama
- Playlist → placeholder menu daftar tontonan
- Profile → placeholder profil pengguna

Desain menggunakan warna dasar hitam dengan ikon putih dan abu-abu untuk item yang belum dipilih.
...
Berikut hasil akhir tampilan aplikasi “TONTONANMU”, menampilkan:
- AppBar berwarna merah dengan teks tebal
- Banner carousel di bagian atas
- Section film mini di bawahnya

Bottom navigation bar di bagian bawah layar
